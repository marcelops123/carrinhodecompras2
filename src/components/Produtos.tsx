...
export const Produtos = () => {
    return (
        ...
        <Box id="boxprodutos" padding={2}  boxShadow={'1px 1px 8px black'}  backgroundColor={'white'}   >
        ...
        <Box id="boxprodutos" padding={2}     boxShadow={'1px 1px 8px black'} fontSize={8} backgroundColor={'white'}     >
