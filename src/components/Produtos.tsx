import { Text, Box, Divider, Image, Button, Badge } from "@chakra-ui/react"
...
export const Produtos = () => {
    return (
        <>
            ...
            <Box id="boxprodutos" padding={2} maxW={'240px'} boxShadow={'1px 1px 8px black'} backgroundColor={'white'}   >
            ...
            <Box id="boxprodutos" padding={2} maxW={'240px'} boxShadow={'1px 1px 8px black'} fontSize={8} backgroundColor={'white'}     >
                ...
                <Button borderRadius={6} fontSize={18} fontFamily={'Alata, sans-serif'} _focus={{}} borderX={2} borderY={2} width='95%' height={50} borderStyle={'solid'} colorScheme={'#42d4ed'} outlineColor={'#42d4ed'} textColor={'#42d4ed'} marginLeft={2}><b>Adicionar ao carrinho</b></Button>
